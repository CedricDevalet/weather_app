...
const CLEFAPI = 'eff2fd89373bd83b7cb40ef43710c9c4';
let resultAPI;
...
if(navigator.geolocation) {
    navigator.geolocation.getCurrentPosition(position => {
        ...
        alert(`Vous n'avez autoriser l'application à vous géolocaliser, veuillez recharger la page et l'autoriser !` )
    })
}
...
function AppelAPI(long, lat) {
    ...
    .then((data) => {
        ...
        //Les heures par tranche de trois avec l'heure temperature.
        ...
        //Trois premiere lettre des jours 
